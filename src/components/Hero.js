    ...
    <>
      <section id="hero" className="min-h-screen flex items-center justify-center px-4 pb-24 bg-gray-50">
        <div className="max-w-4xl mx-auto text-center mt-12">
          {/* Small text on top */}
          <p className="text-md font-jameel mb-6" style={{ color: 'var(--gold-light)', fontFamily: 'Mehr', letterSpacing: '0.05em', lineHeight: '1.8', wordSpacing: '0.1em' }}>
      ...
      <section id="about" className="py-16 px-4 bg-gray-50">
        <div className="max-w-5xl mx-auto">
          {/* Main Heading */}
          <h2 className="text-3xl md:text-4xl font-bold text-center mb-8 font-jameel" style={{ color: 'var(--foreground)', fontFamily: 'Mehr', letterSpacing: '0.06em', lineHeight: '1.6', wordSpacing: '0.12em' }}>
            تحریک إيمان و تقوی کربوغہ شریف
          </h2>

          {/* Description */}
          <p className="text-base md:text-lg leading-relaxed text-justify mb-12 font-jameel" style={{ color: 'var(--foreground)', fontFamily: 'Mehr', letterSpacing: '0.04em', lineHeight: '1.8', wordSpacing: '0.08em' }}>
          ...
          {/* Objectives Heading */}
          <h3 className="text-2xl md:text-3xl font-bold mb-8 text-center font-jameel" style={{ color: 'var(--foreground)', fontFamily: 'Mehr', letterSpacing: '0.08em', lineHeight: '1.6', wordSpacing: '0.15em' }}>
            مقاصد
          </h3>

          <p className="text-base md:text-lg text-center mb-10 font-jameel" style={{ color: '#000000', fontFamily: 'Mehr', letterSpacing: '0.04em', lineHeight: '1.7', wordSpacing: '0.1em' }}>
          ...
          <div className="space-y-8">
            {/* Objective 1 */}
            <div className="p-6 rounded-lg border-r-4" style={{ backgroundColor: 'var(--accent)', borderRightColor: 'var(--gold)' }}>
              <h4 className="text-xl font-bold mb-4 font-jameel" style={{ color: 'var(--foreground)', fontFamily: 'Mehr', letterSpacing: '0.06em', lineHeight: '1.6', wordSpacing: '0.12em' }}>۱۔ تزکیہ نفس</h4>
              <p className="text-base leading-relaxed text-justify font-jameel" style={{ color: 'var(--foreground)', fontFamily: 'Mehr', letterSpacing: '0.04em', lineHeight: '1.8', wordSpacing: '0.08em' }}>
            ...
            {/* Objective 2 */}
            <div className="p-6 rounded-lg border-r-4" style={{ backgroundColor: 'var(--accent)', borderRightColor: 'var(--gold)' }}>
              <h4 className="text-xl font-bold mb-4 font-jameel" style={{ color: 'var(--foreground)', fontFamily: 'Mehr', letterSpacing: '0.06em', lineHeight: '1.6', wordSpacing: '0.12em' }}>۲۔ پورے دین پر پورا عمل</h4>
              <p className="text-base leading-relaxed text-justify font-jameel" style={{ color: 'var(--foreground)', fontFamily: 'Mehr', letterSpacing: '0.04em', lineHeight: '1.8', wordSpacing: '0.08em' }}>
            ...
            {/* Objective 3 */}
            <div className="p-6 rounded-lg border-r-4" style={{ backgroundColor: 'var(--accent)', borderRightColor: 'var(--gold)' }}>
              <h4 className="text-xl font-bold mb-4 font-jameel" style={{ color: 'var(--foreground)', fontFamily: 'Mehr', letterSpacing: '0.06em', lineHeight: '1.6', wordSpacing: '0.12em' }}>۳۔ اتحاد امت</h4>
              <p className="text-base leading-relaxed text-justify font-jameel" style={{ color: 'var(--foreground)', fontFamily: 'Mehr', letterSpacing: '0.04em', lineHeight: '1.8', wordSpacing: '0.08em' }}>
      ...
      <section id="sections" className="py-16 px-4 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          {/* Section Heading */}
          <h2 className="text-3xl md:text-4xl font-bold text-center mb-16 font-jameel" style={{ color: 'var(--foreground)', fontFamily: 'Mehr', letterSpacing: '0.06em', lineHeight: '1.6', wordSpacing: '0.12em' }}>
            شعبہ جات
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <Link href="/intro" className="p-6 rounded-xl h-40 flex flex-col justify-between relative overflow-hidden transition-transform hover:scale-105 cursor-pointer" style={{ backgroundColor: 'var(--accent)' }}>
              ...
              <div className="mt-auto text-right">
                <h3 className="text-xl font-bold mb-1 font-jameel" style={{ color: 'var(--primary)', fontFamily: 'Mehr', letterSpacing: '0.05em', lineHeight: '1.6' }}>تعارف بانی</h3>
                <p className="text-xs font-jameel" style={{ color: 'var(--warm-brown)', fontFamily: 'Mehr', letterSpacing: '0.04em', lineHeight: '1.5' }}>حضرت مفتی سید مختار الدین شاہ صاحب کا تعارف</p>
              </div>
            </Link>
            ...
            <Link href="/curriculum" className="p-6 rounded-xl h-40 flex flex-col justify-between relative overflow-hidden transition-transform hover:scale-105 cursor-pointer" style={{ backgroundColor: 'var(--accent)' }}>
              ...
              <div className="mt-auto text-right">
                <h3 className="text-xl font-bold mb-1 font-jameel" style={{ color: 'var(--primary)', fontFamily: 'Mehr', letterSpacing: '0.05em', lineHeight: '1.6' }}>منہج و نظام</h3>
                <p className="text-xs font-jameel" style={{ color: 'var(--warm-brown)', fontFamily: 'Mehr', letterSpacing: '0.04em', lineHeight: '1.5' }}>اصلاحی و تربیتی منہج</p>
              </div>
            </Link>
            ...
            <Link href="/quotes" className="p-6 rounded-xl h-40 flex flex-col justify-between relative overflow-hidden transition-transform hover:scale-105 cursor-pointer" style={{ backgroundColor: 'var(--accent)' }}>
              ...
              <div className="mt-auto text-right">
                <h3 className="text-xl font-bold mb-1 font-jameel" style={{ color: 'var(--primary)', fontFamily: 'Mehr', letterSpacing: '0.05em', lineHeight: '1.6' }}>ملفوظات</h3>
                <p className="text-xs font-jameel" style={{ color: 'var(--warm-brown)', fontFamily: 'Mehr', letterSpacing: '0.04em', lineHeight: '1.5' }}>حضرت مفتی سید مختار الدین شاہ صاحب کا تعارف</p>
              </div>
            </Link>
            ...
            <Link href="/books" className="p-6 rounded-xl h-40 flex flex-col justify-between relative overflow-hidden transition-transform hover:scale-105 cursor-pointer" style={{ backgroundColor: 'var(--accent)' }}>
              ...
              <div className="mt-auto text-right">
                <h3 className="text-xl font-bold mb-1 font-jameel" style={{ color: 'var(--primary)', fontFamily: 'Mehr', letterSpacing: '0.05em', lineHeight: '1.6' }}>کتب</h3>
                <p className="text-xs font-jameel" style={{ color: 'var(--warm-brown)', fontFamily: 'Mehr', letterSpacing: '0.04em', lineHeight: '1.5' }}>مفید علمی و اصلاحی کتابیں</p>
              </div>
            </Link>
            ...
            <Link href="/recordings" className="p-6 rounded-xl h-40 flex flex-col justify-between relative overflow-hidden transition-transform hover:scale-105 cursor-pointer" style={{ backgroundColor: 'var(--accent)' }}>
              ...
              <div className="mt-auto text-right">
                <h3 className="text-xl font-bold mb-1 font-jameel" style={{ color: 'var(--primary)', fontFamily: 'Mehr', letterSpacing: '0.05em', lineHeight: '1.6' }}>ریکارڈنگز</h3>
                <p className="text-xs font-jameel" style={{ color: 'var(--warm-brown)', fontFamily: 'Mehr', letterSpacing: '0.04em', lineHeight: '1.5' }}>بیانات، کلام اور تلاوت</p>
              </div>
            </Link>
            ...
            <Link href="/campuses" className="p-6 rounded-xl h-40 flex flex-col justify-between relative overflow-hidden transition-transform hover:scale-105 cursor-pointer" style={{ backgroundColor: 'var(--accent)' }}>
              ...
              <div className="mt-auto text-right">
                <h3 className="text-xl font-bold mb-1 font-jameel" style={{ color: 'var(--primary)', fontFamily: 'Mehr', letterSpacing: '0.05em', lineHeight: '1.6' }}>مراکز و مجالس</h3>
                <p className="text-xs font-jameel" style={{ color: 'var(--warm-brown)', fontFamily: 'Mehr', letterSpacing: '0.04em', lineHeight: '1.5' }}>مختلف مقامات پر مجالس</p>
              </div>
            </Link>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="flex flex-col justify-center">
              ...
              <div className="p-8 rounded-3xl" style={{ backgroundColor: 'var(--accent)', border: '2px solid var(--secondary)' }}>
                {/* Donations Heading */}
                <h3 className="text-2xl font-bold mb-6 text-right font-jameel" style={{ color: 'var(--foreground)', fontFamily: 'Mehr', letterSpacing: '0.06em', lineHeight: '1.6' }}>عطیات</h3>

                {/* Account Title */}
                <div className="mb-6 text-end pb-6 border-b-2" style={{ borderColor: 'var(--secondary)' }}>
                  <p className="text-sm mb-2 text-start font-jameel" style={{ color: '#000000', fontFamily: 'Mehr', letterSpacing: '0.04em' }}>اکاؤنٹ ٹائٹل</p>
                  <p className="text-lg font-semibold" style={{ color: '#000000' }}>Muhammad Jafar</p>
                </div>

                {/* Bank Details */}
                <div className="mb-6 text-end pb-6 border-b-2" style={{ borderColor: 'var(--secondary)' }}>
                  <p className="text-sm mb-2 text-start font-jameel" style={{ color: '#000000', fontFamily: 'Mehr', letterSpacing: '0.04em' }}>بینک</p>
                  <p className="text-base font-semibold" style={{ color: '#000000' }}>Meezan Bank, Doaba Branch</p>
                </div>

                {/* IBAN */}
                <div className="mb-6 text-end pb-6 border-b-2" style={{ borderColor: 'var(--secondary)' }}>
                  <p className="text-sm mb-2 font-jameel" style={{ color: '#000000', fontFamily: 'Mehr', letterSpacing: '0.04em' }}>IBAN</p>
                  <p className="text-sm font-mono" style={{ color: '#000000' }}>PK31MEZN0026510107239161</p>
                </div>

                {/* Blessing Message */}
                <p className="font-jameel text-center" style={{ color: '#000000', fontFamily: 'Mehr', letterSpacing: '0.04em', lineHeight: '1.8', fontSize: '0.95rem' }}>
            ...
            <div className="flex flex-col justify-center" dir="rtl">
              ...
              <div className="mb-8 flex items-start gap-4 flex-row-reverse">
                ...
                <div className="text-right">
                  <h3 className="text-lg font-bold mb-2 font-jameel" style={{ color: 'var(--foreground)', fontFamily: 'Mehr', letterSpacing: '0.05em', lineHeight: '1.6' }}>مرکز خانقاہ دارالایمان والتقویٰ</h3>
                  <p className="font-jameel" style={{ color: '#000000', fontFamily: 'Mehr', letterSpacing: '0.04em', lineHeight: '1.7' }}>کربوغہ شریف، پاکستان</p>
                </div>
              </div>
              ...
              <div className="mb-8 flex items-start gap-4 flex-row-reverse">
                ...
                <div className="text-right">
                  <p className="font-jameel text-base" dir="ltr" style={{ color: 'var(--foreground)', fontFamily: 'Mehr', letterSpacing: '0.04em', lineHeight: '1.6' }}>+92-328-0899651</p>
                </div>
              </div>
              ...
              <div className="mb-8 flex items-start gap-4 flex-row-reverse">
                ...
                <div className="text-right">
                  <p className="font-jameel text-base" dir="ltr" style={{ color: 'var(--foreground)', fontFamily: 'Mehr', letterSpacing: '0.04em', lineHeight: '1.6' }}>+92-317-7930224</p>
                </div>
              </div>
