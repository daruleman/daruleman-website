    ...
    <div className="bg-gray-50 min-h-screen">
      ...
      <section className="pt-32 pb-8 px-4" style={{ scrollMarginTop: '80px', paddingTop: '120px' }}>
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="text-lg md:text-xl" style={{ color: '#000000', fontFamily: 'Mehr', letterSpacing: '0.06em' }}>
        ...
        <section className="w-full py-16 px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-right font-jameel mb-12" style={{ color: 'var(--foreground)', fontFamily: 'Mehr', letterSpacing: '0.06em' }}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                ...
                <div key={index} className="rounded-xl p-6 flex items-center gap-4 bg-white border-2 border-gray-200">
                  ...
                  <p className="font-jameel font-bold text-right" style={{ color: 'var(--foreground)', fontFamily: 'Mehr', letterSpacing: '0.04em' }}>{item.text}</p>
                </div>
              ))}
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {[
                ...
                <div key={index} className="rounded-2xl p-8 text-center bg-white border-2 border-gray-200">
                  ...
                  <p className="font-jameel font-bold" style={{ color: 'var(--foreground)', fontFamily: 'Mehr', letterSpacing: '0.04em', fontSize: '1.1rem' }}>{item.text}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        <section className="w-full py-16 px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-right font-jameel mb-12" style={{ color: '#000000', fontFamily: 'Mehr', letterSpacing: '0.06em' }}>
              اصلاحی و تربیتی منہج
            </h2>

            <div className="space-y-6">
              <div className="rounded-2xl p-8 bg-white border-2 border-gray-200">
                <h3 className="text-xl font-bold text-right font-jameel mb-4" style={{ color: '#000000', fontFamily: 'Mehr', letterSpacing: '0.05em' }}>
                  عقائد اور فکر و نظر کی تطہیر
                </h3>
                <p className="font-jameel text-right" style={{ color: '#000000', fontFamily: 'Mehr', letterSpacing: '0.04em', lineHeight: '1.8' }}>
