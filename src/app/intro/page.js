  ...
  return (
    <div style={{ backgroundColor: '#F3F4F6', minHeight: '100vh', paddingTop: '80px' }}>
      ...
      <div className="text-center py-20 px-4">
        <h1 className="text-4xl md:text-5xl font-bold mb-3" style={{ color: 'var(--foreground)', fontFamily: 'Mehr', letterSpacing: '0.008em' }}>
          تعارف بانی
        </h1>
        <h2 className="text-3xl md:text-4xl font-semibold mt-8" style={{ color: 'var(--primary)', fontFamily: 'Mehr', letterSpacing: '0.006em' }}>
      ...
      <div className="px-4 pb-20">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-16 p-10 rounded-xl" style={{ backgroundColor: 'var(--accent)', boxShadow: '0 4px 12px rgba(0, 0, 0, 0.08)' }}>
            <p className="leading-relaxed" style={{ color: 'var(--foreground)', fontFamily: 'Mehr', fontSize: '1.15rem', lineHeight: '2.4', textAlign: 'right', wordSpacing: '0.08em' }}>
          ...
          <div className="p-10 rounded-xl" style={{ backgroundColor: '#FFFFFF', borderRight: '5px solid var(--gold)', boxShadow: '0 4px 12px rgba(0, 0, 0, 0.06)' }}>
            <h3 className="text-2xl md:text-3xl font-bold mb-5" style={{ color: 'var(--primary)', fontFamily: 'Mehr', textAlign: 'right' }}>
              شیخ الحدیث مولانا محمد زکریا کاندھلوی رحمۃ اللہ علیہ
            </h3>
            <p style={{ color: 'var(--foreground)', fontFamily: 'Mehr', fontSize: '1.1rem', lineHeight: '2.4', textAlign: 'right', wordSpacing: '0.08em' }}>
